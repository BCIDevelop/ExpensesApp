...
export const addCategory = function(categoryList =  document.querySelector('.expense-container__category')){
...
export const addOptionCategory= function(select =document.querySelector('.form__select')){
    select.innerHTML =""
    const categories=Category.listCatgories()
    categories.forEach(element=>{
